...
const ROUTES: Routes = [
  ...
  {path: 'facturas/:id', component: DetalleFacturaComponent, canActivate: [AuthGuard, RolGuard], data: {rol: 'ROLE_USER'}},
  {path: 'facturas/form/:clienteId', component: FacturasComponent, canActivate: [AuthGuard, RolGuard], data: {rol: 'ROLE_ADMIN'}}
]
